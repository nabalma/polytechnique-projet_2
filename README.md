...
Se référer au fichier [CONTRIBUTING.md](./CONTRIBUTING.md) pour des conseils et directives sur la façon de maintenir un projet bien organisé et facile à comprendre pour tous les membres de l'équipe.
...
Consultez le fichier [TESTS.md](./TESTS.md) pour plus de détails sur l'utilisation des tests unitaires et la couverture de code ainsi que comment configurer les projets fournis pour cibler seulement certaines parties du code.
...
Cette section présente les différents standards de programmation qu'on vous recommande de respecter lors de la réalisation de ce projet et qui seront utilisés pour la correction de l'assurance qualité de votre projet.
